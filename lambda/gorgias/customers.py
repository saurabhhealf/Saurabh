...
ENDPOINT = "/customers"
ORDER_BY_FIELD = "created_datetime"   # safest for backfill
...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    max_pages = int(job.get("max_pages", 25))
    ...
    return {"stream": "customers", "run_id": run_id, "pages_written": pages_written, "continued": bool(next_cursor)}
